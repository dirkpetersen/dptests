...
subLanguage:"bash"}}]})})());hljs.registerLanguage("tcl",(()=>{"use strict";function e(...e){
...
variants:[a.inherit(a.QUOTE_STRING_MODE,{illegal:null})]},r]};var n}})());hljs.registerLanguage("awk",(()=>{"use strict";return e=>({name:"Awk",keywords:{
...
end:"$",illegal:"\n"},o]}}})());hljs.registerLanguage("mathematica",(()=>{"use strict"
...
},e.COMMENT("\\*",";"),e.C_BLOCK_COMMENT_MODE]})})());hljs.registerLanguage("latex",(()=>{"use strict";return e=>{const n=[{
