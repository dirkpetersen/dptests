...
[Systems biology, 2009 - Springer, **Ch 5,** pp 113–167.](https://link.springer.com/protocol/10.1007/978-1-59745-525-1_5)


Documentation
* [bionetgen Github page](https://github.com/RuleWorld/bionetgen)
* [BioNetGen Home page](https://bionetgen.org/)
* [BioNetGen Tutorials](https://bionetgen.readthedocs.io/en/latest/pybng_tutorials.html)


Important Notes
* Module Name: bionetgen (see [the modules page](/apps/modules.html) for more information)
  
* Unusual environment variables set
	+ **BIONETGEN\_HOME**  installation directory
	+ **BIONETGEN\_BIN**  executable directory
	+ **BIONETGEN\_DATA**  sample data directory
...
[user@cn3144 ~]$ **cp $BIONETGEN\_TESTS/\* .**
[user@cn3144 ~]$ **bionetgen run -o output\_folder -i BP.bngl**
