...
document.querySelector('title').textContent = 'nda-tools: tools for handling data from the National Institute of Mental Health Data Archives (NDA)"';
**nda-tools: tools for handling data from the National Institute of Mental Health Data Archives (NDA)"**
...
Documentation
* [nda-tools Github page](https://github.com/NDAR/nda-tools)
* [nda-tools Home page](https://nda.nih.gov/tools/nda-tools.html)
* [How to get data from the NDA using command line tools](https://wiki.humanconnectome.org/display/PublicData/How+to+get+data+from+the+NDA+using+command+line+tools)


Important Notes
* Module Name: nda-tools (see [the modules page](https://hpc.nih.gov/apps/modules.html) for more information)
* Implemented as a Singularity container
* Unusual environment variables set
	+ **NDA-TOOLS\_HOME**  installation directory
	+ **NDA-TOOLS\_BIN**    executables directory
	+ **NDA-TOOLS\_DATA**  sample data directory
...
[user@cn4192 ~]$ **module load nda-tools** 
...
[user@cn3123 user]$ **downloadcmd -h**
